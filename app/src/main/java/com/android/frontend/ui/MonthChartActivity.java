...
import com.android.frontend.adapter.ChartVPAdapter;
import com.android.frontend.dialog.CalendarDialog;
import com.android.frontend.db.DBManager;
import com.android.frontend.fragment.chartFragment.IncomChartFragment;
import com.android.frontend.fragment.chartFragment.OutcomChartFragment;
...
//        将Fragment加载到Acitivy当中
    ...
    private void setButtonStyle(int kind){
        if (kind == 0) {
            outBtn.setBackgroundResource(R.drawable.btn_common);
            outBtn.setTextColor(Color.WHITE);
            inBtn.setBackgroundResource(R.drawable.btn_cancel);
            inBtn.setTextColor(Color.BLACK);
        }else if (kind == 1){
            inBtn.setBackgroundResource(R.drawable.btn_common);
            inBtn.setTextColor(Color.WHITE);
            outBtn.setBackgroundResource(R.drawable.btn_cancel);
