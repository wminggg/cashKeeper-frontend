...
import com.android.frontend.dialog.BudgetDialog;
import com.android.frontend.dialog.MoreDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置适配器：加载每一行数据到列表当中
        adapter = new BillAdapter(this, mDatas);
    ...
    private void setLVLongClickListener() {
        todayLv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int pos = position-1;
                BillBean clickBean = mDatas.get(pos);  //获取正在被点击的这条信息
    ...
    /* 弹出是否删除某一条记录的对话框*/
    private void showDeleteItemDialog(final BillBean clickBean) {
...
//    设置显示运算剩余
    ...
    private void loadDBData() {
        List<BillBean> list = DBManager.getAccountListOneDayFromAccounttb(year, month, day);
        mDatas.clear();
        mDatas.addAll(list);
    ...
    private void showBudgetDialog() {
        BudgetDialog budgetDialog = new BudgetDialog(this, currentView);
        budgetDialog.show();
