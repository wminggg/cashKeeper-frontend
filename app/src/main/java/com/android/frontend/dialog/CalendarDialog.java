...
import com.android.frontend.adapter.CalendarAdapter;
...
public class CalendarDialog extends Dialog implements View.OnClickListener {
    ...
    private int selectPos = -1;   //表示正在被点击的年份的位置
    ...
    private void addViewToLayout() {
        ...
        for (int i = 0; i < yearList.size(); i++) {
            ...
            hsvTv.setText(String.valueOf(year));
    ...
    /**
     * @Description: 给横向的ScrollView当中每一个TextView设置点击事件
     */
    ...
    /**
     * @Description: 传入被选中的位置，改变此位置上的背景和文字颜色
     * @see int
     */
    ...
    private void changeTvbg(int selectPos) {
        for (int i = 0; i < hsvViewList.size(); i++) {
            ...
            tv.setBackgroundResource(R.drawable.btn_cancel);
            tv.setTextColor(Color.BLACK);
        }

        TextView selView = hsvViewList.get(selectPos);
        selView.setBackgroundResource(R.drawable.btn_common);
