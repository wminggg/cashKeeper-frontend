package com.android.frontend.db;

import android.content.ContentValues;
import android.content.Context;
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;
import com.android.frontend.common.utils.FloatUtils;
...
//        循环读取游标内容，存储到对象当中
    ...
    * 向记账表当中插入一条元素
    * */
    public static void insertItemToAccounttb(BillBean bean){
    ...
    * */
    public static List<BillBean>getAccountListOneDayFromAccounttb(int year, int month, int day){
        ...
        while (cursor.moveToNext()) {
            ...
            BillBean billBean = new BillBean(id, typename, sImageId, beizhu, money, time, year, month, day, kind);
            list.add(billBean);
        }
        return list;
    }
     ...
     * */
    public static List<BillBean>getAccountListOneMonthFromAccounttb(int year, int month){
        List<BillBean>list = new ArrayList<>();
    ...
    * */
     ...
     * 根据备注搜索收入或者支出的情况列表
     * */
    public static List<BillBean>getAccountListByRemarkFromAccounttb(String beizhu){
        List<BillBean>list = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            int day = cursor.getInt(cursor.getColumnIndex("day"));
            BillBean billBean = new BillBean(id, typename, sImageId, bz, money, time, year, month, day, kind);
            list.add(billBean);
        }
        return list;
    }
